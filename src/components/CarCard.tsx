...
const CarCard = ({ car }: CarProps) => {
  const itemStyle = `col-span-2 lg:col-span-1 flex gap-2 border px-4 py-1 rounded-full`;
  return (
    <div className='cursor-pointer'>
      <Link href={`/voiture/${car.id}`}>
        <div className='relative h-[200px] lg:h-[250px] xl:h-[350px] rounded-lg overflow-hidden'>
        ...
        <div className='mt-2 flex flex-col font-bold'>
          ...
          <div className='flex justify-between'>
            ...
            <span className='italic text-slate-400 font-medium'>S-line</span>
          </div>
        </div>
